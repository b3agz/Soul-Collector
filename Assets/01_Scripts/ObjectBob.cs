...
namespace SoulCollector {
    ...
    public class ObjectBob : MonoBehaviour {
        ...
        void Update() {
            ...
            // Get the current height of the GameObject by feeding Time.time (seconds since game started) into
            // the Mathf.Sin function, which gives us a smooth height bob between -1 and 1. Multiplying it
            // by speed changes how quickly we move along the sine wave, and multiplying the result by an amount
